			...
			<table class="tab_login">
				<tr>
					...
					<td><input type="text" class="text_input"
						name="addr.receive_name" id="receiveName" />
				...
				<tr>
					...
					<td><input type="text" name="addr.full_address"
				...
				<tr>
					...
					<td><input type="text" class="text_input"
						name="addr.postal_code" id="postalCode" />
				...
				<tr>
					...
					<td><input type="text" class="text_input" name="addr.phone"
						id="phone" />
				...
				<tr>
					...
					<td><input type="text" class="text_input" name="addr.mobile"
						id="mobile" />
